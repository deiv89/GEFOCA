...
<link rel="stylesheet" type="text/css"
	href="resources/candidateDetailCSS.css">
</head>
<body>
	<%
	...
	<br>
	<div>
		Scarica CV candidato <a
			href="DownloadServlet?pathCv=${candidate.pathCv}">Download</a>
	</div>
	<div>
	...
	<br>
	<a
		href="EvaluationUpdateServlet?surname=${candidate.surname}&idCandidate=${candidate.idCandidate}&idOrigin=${candidate.idOrigin}">MODIFICA
		SCHEDA DI VALUTAZIONE</a>
	<br>
	...
	<br>
	<a
		href="SkillsUpdateServlet?surname=${candidate.surname}&idCandidate=${candidate.idCandidate}&idOrigin=${candidate.idOrigin}">MODIFICA
		SKILL MATRIX</a>
	<br>
	...
	<br>
	<a
		href="OriginUpdateServlet?surname=${candidate.surname}&idCandidate=${candidate.idCandidate}&idOrigin=${candidate.idOrigin}">MODIFICA
		CANALE PROVENIENZA</a>
	<br>
