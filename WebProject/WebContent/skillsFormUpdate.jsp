...
<link rel="stylesheet" type="text/css" href="resources/skillsUpdateCSS.css">
...
<body>
	...
	<br>
	<a href="CandidateDetailServlet?idCandidate=${idCandidate}&surname=${surname}&idOrigin=${idOrigin}">ANNULLA E TORNA ALLA HOMEPAGE</a>
