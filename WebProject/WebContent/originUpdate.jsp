...
<link rel="stylesheet" type="text/css" href="resources/originUpdateCSS.css">
...
<body>
	...
	<form action="originUpdateServlet" method="post">
		<table>
			<tr>
				<td>Descrizione:</td>
				<td><input type="text" name="description" value="${origin.description}"/></td>
			</tr>
			<tr>
				<td>Indirizzo:</td>
			...
			<tr>
				...
				<input
					...
					<input
					type="hidden" name="idOrigin" value="${idOrigin}"></td></td>
			</tr>
		</table>
	</form>

	<br>
	<a href="CandidateDetailServlet?idCandidate=${idCandidate}&surname=${surname}&idOrigin=${idOrigin}">ANNULLA E TORNA INDIETRO</a>
