...
<link rel="stylesheet" type="text/css"
	href="resources/evalFormCreateCSS.css">
</head>
<body>
	<%
		...
		<table>
			...
			<c:forEach items="${requestScope.languagesList}" var="lang">
				<tr>
					...
					<td><input type="radio" name="${languageLevel}" value="0">
						0 <input type="radio" name="${languageLevel}" value="1"> 1
						<input type="radio" name="${languageLevel}" value="2"> 2 <input
						type="radio" name="${languageLevel}" value="3">3 <input
						type="radio" name="${languageLevel}" value="4"> 4</td>
				</tr>
			</c:forEach>
			<tr>
